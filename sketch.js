...
function setup()
 {
	...
	box1 = createSprite(375, groundSprite.y, 100, 10);
	box1.shapeColor = ("red")
	box2 = createSprite(325, box1.y - 20, 10, 50);
	box2.shapeColor = ("red")
	box3 = createSprite(425, box1.y - 20, 10, 50);
	box3.shapeColor = ("red")
	//Create a Ground
...
function draw() 
{
  ...
  /*if(packageBody.y > 670)
  {
    packageBody.y= 662.5;
  }*/
  //box1.x = packageBody.x;
